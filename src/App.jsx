  ...
  return (
    <div className="min-h-screen overflow-x-hidden text-[var(--storm-text)]">
      ...
      <main
        id="main-content"
        tabIndex={-1}
        className={`page-container page-content focus:outline-none ${user ? "account-page-container max-lg:pb-28" : ""}`}
      >
        <AppErrorBoundary>
          <Suspense fallback={<PageFallback />}>
            <Routes>
              ...
              <Route path="/dev/scoring" element={developerScoringEnabled ? <ProtectedPage><SafeRoute><DeveloperScoringPage /></SafeRoute></ProtectedPage> : <Navigate to="/" replace />} />
              <Route path="/dev/trends" element={developerTrendsEnabled ? <ProtectedPage><SafeRoute><DeveloperTrendsPage /></SafeRoute></ProtectedPage> : <Navigate to="/" replace />} />
              <Route path="/dev/analytics" element={developerAnalyticsEnabled ? <ProtectedPage><SafeRoute><DeveloperAnalyticsPage /></SafeRoute></ProtectedPage> : <Navigate to="/" replace />} />
