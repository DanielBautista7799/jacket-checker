...
export default function ResetPasswordPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await resetPasswordWithServerPolicy({
    ...
    >
      <div className="glass-nav rounded-[var(--radius-hero)] p-5 sm:p-8">
        ...
        <p className="mt-3 text-sm leading-6 text-slate-400">
          ...
          not use on any other site.
        </p>

        {authLoading && (
          <div className="mt-6">
            <Alert>
              Checking your secure recovery
              link...
            </Alert>
          </div>
        )}
        ...
        {missingRecoverySession && (
          <div className="mt-6 space-y-4">
            ...
            >
              ...
              password-reset link. The link
              may have expired or already
              been used.
            </Alert>
