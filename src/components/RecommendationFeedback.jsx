  ...
  return (
    <div className="rounded-3xl border border-purple-400/20 bg-purple-400/10 p-5">
      <p className="font-bold text-white">
        Did this jacket and style idea work?
      </p>

      <p className="mt-1 text-xs leading-5 text-purple-100/70">
        Your answer helps future checks learn which jackets work best in similar weather.
      </p>
      ...
      {value && (
        <p className="mt-3 text-center text-xs text-purple-200">
          Saved — future checks will use this in similar conditions.
        </p>
      )}
    </div>
  );
