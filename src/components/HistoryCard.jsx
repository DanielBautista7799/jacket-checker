...
const imageStatus = wardrobeLoading
    ? "Loading current wardrobe photo…"
    : wardrobeItem
    ? resolvedImageUrl
        ? "Current primary wardrobe photo"
        : "No photo is currently saved for this item"
    : wardrobeItemId
        ? "This wardrobe item is no longer available"
        : "No wardrobe item was attached to this recommendation";
...
return (
    ...
    {shouldShowImage && (
        ...
        {wardrobeLoading ? (
            ...
            <WardrobeImage
            item={wardrobeItem}
            alt={`${wardrobeItem?.name || entry.jacket_name || "Recommended jacket"} current primary wardrobe photo`}
